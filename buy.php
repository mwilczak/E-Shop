...
<div class="container">
    ...
    <div class="page-header">
        <h2 class="text-left">Koszyk</h2>
        <p class="text-right">
            <button class="btn btn-success" data-toggle="modal" data-target="#myModal" data-backdrop="static"
                    data-keyboard="false">Finaluzuj zamówienie
            </button>
        </p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="#">
                            ...
                            <div class="group">
                                <label></label>
                                <input type="submit" name="order_submit" class="btn btn-info btn-lg btn-block"
                                       value="Wyślij">
                            </div>
                        </form>
