        ...
        while ($chkSelectRows = mysqli_fetch_assoc($chkSelectQuery)){
            ...
            echo "
                    <tr>
                        ...
                        <td><input type='number' style='width: 45px;' min="1" onblur="up_chk_qty(this.value, '<?php echo $chkSelectRows['chk_id']; ?>');" value='<?php echo $chkSelectRows['chk_qty']; ?>'></td>
                        <td><button class='btn btn-danger btn-sm' onclick="del_func(<?php echo $chkSelectRows['chk_id'];?>);">Usuń</button></td>
